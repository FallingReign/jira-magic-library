...
- ✅ [S2: Fuzzy User Matching](stories/BACKLOG-STORY-002-fuzzy-user-matching.md) - 5 points *(GitHub Copilot)*
...
- ✅ [S7: Post-Creation Attachment API (`issues.addAttachments`)](stories/STANDALONE-STORY-007-add-attachments-api.md) - 5 points *(GitHub Copilot, PR #1)*
